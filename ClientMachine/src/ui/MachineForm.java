...
public class MachineForm extends javax.swing.JInternalFrame {
    ...
    public void loadCombo() {
        ...
        salles = daoSalle.findAll(); // Assuming findAll() returns a List of Salle objects
        for (Salle s : salles) {
            comboBoxSalle.addItem(s); // This will display the code of the Salle
        }
    } catch (RemoteException ex) {
        Logger.getLogger(MachineForm.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Gestionnaire des machines");
        ...
        bnDelete.setForeground(new java.awt.Color(204, 0, 0));
        ...
        listMachines.setBackground(new java.awt.Color(204, 204, 204));
    ...
    private void listMachinesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listMachinesMouseClicked
        ...
        if (selectedIndex != -1) {
            ...
            // Find the corresponding Salle object for the selected Machine
            Salle selectedSalle = null;
            for (Machine m : machines) {
                if (m.getId() == idMachine) {
                    selectedSalle = m.getSalle();
                    break;
                }
            }

            // Set the selected Salle in the comboBoxSalle
            if (selectedSalle != null) {
                comboBoxSalle.setSelectedItem(selectedSalle);
            }
        }
